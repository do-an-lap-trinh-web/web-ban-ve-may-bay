        ...
        <c:if test="${not empty user}">
            <div class="content">
                ...
                <div class="btn-container">
                    <a href="${pageContext.request.contextPath}/admin/user-controller" class="btn btn-cancel">Quay lại</a>
                    <a href="${pageContext.request.contextPath}/admin/suaUser?id=${user.id}" class="btn btn-edit">Chỉnh sửa</a>
                </div>
            </div>
        </c:if>
