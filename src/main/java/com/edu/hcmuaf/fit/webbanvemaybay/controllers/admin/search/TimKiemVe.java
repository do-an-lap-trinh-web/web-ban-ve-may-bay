...
@WebServlet(name = "TimKiemVe", value = "/admin/TimKiemVe")
public class TimKiemVe extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Ve> listVe = veService.getVeByPageAndInput(page, pageSize, input);
        int totalPages = veService.getTotalPagesByInput(pageSize, input);
